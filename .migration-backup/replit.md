...
- **Auth strategy**: Original app used next-auth v5 + Google OAuth + PrismaAdapter. On Replit, auth should be implemented in the Express server via Replit Auth or a custom JWT flow.
...
- **AI features**: Outfit generation using an OpenAI-compatible AI provider (BlueMinds)
...
- Theme colors are warm orange/amber (`--primary: 24.6 95% 53.1%`).
