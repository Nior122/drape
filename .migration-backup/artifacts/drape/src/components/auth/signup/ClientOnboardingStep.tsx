...
export function ClientOnboardingStep({ onComplete }: ClientOnboardingStepProps) {
  ...
  const handleSkip = () => {
    // If they skip, they haven't saved preferences, but maybe we mark onboarding complete?
    // According to specs: "Skip for now" link.
    // If we call API with empty data, it might complete onboarding.
